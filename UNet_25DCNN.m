%% ========================================================================
%  CLAW SEGMENTATION WITH A PLAIN 2.5D U-NET (No ResNet50)
%  ------------------------------------------------------------------------
...
%    4. Train a plain U-Net (built from scratch, no ResNet50) with
...
basePath = "C:\Users\s2278791\Music\CLAW MATLAB CODE_segmentation\CLAW_data";
...
fprintf('\n========================================');
fprintf('\nSTARTING LOOCV WITH VALIDATION SET (PLAIN 2.5D U-NET)');
fprintf('\n========================================\n');
...
for testClawIdx = 1:numValidClaws
    ...
    % ================================================================
    %  BUILD PLAIN 2.5D U-NET (NO PRETRAINED ENCODER)
    %  ----------------------------------------------------------------
    ...
    % Build the layer array for a plain U-Net
    layers = [
        ...
        batchNormalizationLayer('Name', 'dec3_bn2')                                    % Batch norm        reluLayer('Name', 'dec3_relu2')                                                % ReLU
    ...
    % -------- Train Network --------
    fprintf('Training Fold %d (Plain 2.5D U-Net)...\n', testClawIdx);
    ...
    save(['unet25d_model_fold_' num2str(testClawIdx) '.mat'], 'net');
    fprintf('OK Plain 2.5D U-Net model saved as: unet25d_model_fold_%d.mat\n', testClawIdx);
    ...
    fprintf('\nOK Fold %d Plain 2.5D U-Net Test Accuracy: %.2f%%\n', testClawIdx, accuracy * 100);
...
%% ------------------ 6. OVERALL RESULTS -----------------------
fprintf('\n========================================');
fprintf('\nLEAVE-ONE-OUT CROSS-VALIDATION RESULTS (PLAIN 2.5D U-NET)');
fprintf('\n========================================\n');
...
sgtitle('LOOCV Plain 2.5D U-Net Results for All Claws');
...
title('LOOCV Plain 2.5D U-Net Test Accuracy per Claw');
ylim([0 100]);
grid on;
...
ylabel('Test Accuracy (%)');
title('LOOCV Plain 2.5D U-Net Test Accuracy Distribution');
grid on;
...
results.networkType           = 'Plain 2.5D U-Net (no pretrained encoder)';

% Save results to disk
save('LOOCV_unet25d_results_with_validation.mat', 'results');
fprintf('\nOK Results saved to LOOCV_unet25d_results_with_validation.mat\n');

fprintf('\n========================================');
fprintf('\nPLAIN 2.5D U-NET PROCESS COMPLETED SUCCESSFULLY!');
fprintf('\n========================================\n');